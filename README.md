# I/O Filesystem [![Documentation](https://img.shields.io/docsrs/io-fs)](https://docs.rs/io-fs/latest/io_fs) [![Matrix](https://img.shields.io/matrix/pimalaya:matrix.org?color=success&label=chat)](https://matrix.to/#/#pimalaya:matrix.org)
